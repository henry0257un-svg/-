...
window.CHAPTERS = [
  {
    num:"CHAPTER 01", title:"不存在的記憶", sub:"妳看見的，真的是過去嗎？", progress:8, image:"chapter_1.png",
    scenes:[
  ...
  {
    num:"CHAPTER 02", title:"螢幕外的證據", sub:"如果它只是一個網站，現實裡為什麼會有痕跡？", progress:20, image:"chapter_2.png",
    scenes:[
  ...
  {
    num:"CHAPTER 03", title:"記憶開始有了味道", sub:"這次恢復的，不是畫面。", progress:36, image:"chapter_3.png",
    scenes:[
  ...
  {
    num:"CHAPTER 04", title:"同源記憶", sub:"它和上一段記憶很像，卻準備離開這裡。", progress:52, image:"chapter_4.png",
    scenes:[
  ...
  {
    num:"CHAPTER 05", title:"記憶原點", sub:"那把鑰匙不是答案，只是一張通行證。", progress:68, image:"chapter_5.png",
    scenes:[
  ...
  {
    num:"CHAPTER 06", title:"看得見，卻留不住", sub:"最後的記憶正在變得清楚。", progress:82, image:"chapter_6.png",
    scenes:[
  ...
  {
    num:"CHAPTER 07", title:"把時間留下來", sub:"如果記憶終究會模糊，我們為什麼還要記得？", progress:94, image:"chapter_7.png",
    scenes:[
